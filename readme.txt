Для того, чтобы работать с GitHub через VSC:
   ...
   3) Start a new Terminal and configure your ‘user.name’ and ‘user.email’ in git with the help of the following commands. git config –global user.email “you@example.com”
